    ...
    // hero section animation
{
    return(
        ...
        {/*  FAQ */}
               {/*  FAQ */}
{/* --------------faq------- */}
<section className='portfolio-price-faq'>
  <div>
    <p>FAQ</p>
...
{/* -------------------- */}
<div className='portfolio-price-faq-cateogries'>
  ...
  <div>
    ...
    {categories.map((c) => (
      <button
        ...
        className='portfolio-Price-faq_active'
      >
        {c}
      </button>
    ))}
  ...
  {/* FAQ LIST */}
  <div className='portfolio-price-faq_list'>
    ...
    {faqs[activeTab].map((item, index) => (
      <div key={index}>
        ...
        <div onClick={() => setOpen(open === index ? null : index)} className='portfolio-price-faq-box' >
          <div className='portfolio-price-faq-ques'>
            <div>
              {item.q}
            </div>
            <div>
              <span className='portfolio-price-faq_icon'>{open === index ? <FaChevronDown/> : <FaChevronUp/>}</span>
            </div>
          </div>
          <div className='portfolio-price-faq-ans'>
